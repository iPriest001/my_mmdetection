...
def main():
    xml_path = '/home/mst10512/dataset/data/underwater/val/annotations'
    img_path = '/home/mst10512/dataset/data/underwater/val/images'
    print('processing {} ...'.format("xml format annotations"))
    cvt_annotations(img_path, xml_path, '/home/mst10512/dataset/data/underwater/annotations/val.json')
    print('Done!')
